        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
            ...
            <div
                ...
                <div className="flex-1 p-6 md:p-10">
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black/20"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-black text-white font-semibold py-3 rounded-xl hover:bg-gray-800 transition-colors duration-200 shadow-lg"
                        >
                    ...
                    {error && (
                        <p className="text-center mt-3 text-red-600 text-sm">{error.message}</p>
                    )}
                </div>
